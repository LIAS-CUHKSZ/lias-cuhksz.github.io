...
const newsItems: React.ReactNode[] = [
  <>
    ...
    Shi, Junfeng Wu, Consistent and Optimal Solution to Camera Motion
  ...
  <>
    ...
    visited LIAS (2025.08.06). Dr. Junfeng Wu hosted their talks in CUHKSZ
    School of Data Science Topical Seminar on Safe and Efficient Control with
    Provable Guarantees.
  </>,
  <>
