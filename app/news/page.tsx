...
const newsItems: React.ReactNode[] = [
  <>
    ...
    Wu, Fully Distributed State Estimation for Multi-agent Systems and its Application
    in Cooperative Localization, IEEE Transactions on Control of Network Systems, conditionally accepted.
  </>,
  <>
